...
{
public:
    DFA_MAG(double *data, int data_size, int dfa_order);
    virtual ~DFA_MAG();
...
public:
    ...
    Sync(double *in_datax, double *in_datay, int in_size, int _start, int _end, int type);
    Sync(double *in_datax, double *in_datay, int in_size, int n, int m);
    ~Sync();
...
public:
    ...
    double gamma_index;
    double decay_radio;
    double decay_max_time;

public:
    void plot(std::string name, int seg_size);
    void PSI_decay(std::string name, int t_max, int t_step, std::string method = "rho");
    void PSI_rho(int delay);
    void PSI_lambda(int delay);
    void PSI_gamma(int delay);
    void phasePlot(std::string name);
    void SetIndex(int n, int m);
